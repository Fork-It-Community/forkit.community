...
async function Talk(
  props: Readonly<{ talk: { slug: string }; meetup: Meetup }>,
) {
      ...
      <div className="flex flex-1 flex-col gap-4">
        <div className="flex flex-col gap-1">
          <Link
            ...
            href={`${props.meetup.metadata.slug}/talks/${talk.metadata.slug}`}
          >
...
export function Talks(props: Readonly<{ meetup: Meetup }>) {
  return (
