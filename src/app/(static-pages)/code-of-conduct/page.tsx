  ...
  return (
    <section className="m-auto max-w-7xl px-4 py-16">
      <div className="prose prose-sm prose-invert m-auto md:prose-base prose-headings:scroll-m-10">
        ...
        <p>
          Fork it! Community is dedicated to providing a harassment-free
        ...
        <p>
          ...
          venue, including talks, codelabs, animations, parties, social
          networks. Conference participants violating these rules may be
        ...
        <p>
          Fork it! Community is dedicated to providing a harassment-free
          conference experience for everyone, regardless of and not limited to
          ...
          Sexually objectifying presentation or sexual language and imagery is
        ...
        <p>
          You can make an{" "}
          <a href="https://forms.gle/hAsybzpniKeiR7ou6">
        ...
        <ul>
          <li>
            sending an email to{" "}
            <a href="mailto:contact@forkit.community">
              contact@forkit.community
            </a>
          </li>
          <li>contacting a staff member, identified by staff shirts</li>
        </ul>
        <p>
          ...
          report is managed properly. Once safe, we&apos;ll ask you to tell us
          about what happened. This can be upsetting, but we&apos;ll handle it
          as respectfully as possible, and you can bring someone to support you.
          You won&apos;t be asked to confront anyone and we won&apos;t tell
          anyone who you are.
        </p>
        <p>
