  ...
  photos:
    ...
    sources:
      - image: images/group-photo.jpg
        alt: Attendees, organizers, volunteers, and speakers taking a group photo on stage
      - image: images/roundtable.jpg
        alt: Aziz Ouertani hosting a roundtable about AI and software delivery on stage
      - image: images/eya-laouini-speaking.jpg
        alt: Eya Laouini presenting her talk in front of the audience
      - image: images/audience-qa.jpg
        alt: Audience watching Eya Laouini's talk about Vortex AI during its Q&A session
prospectus:
