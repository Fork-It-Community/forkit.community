...
location:
  ...
  address: Tầng 12, Khu văn phòng, Toà Mipec Tower 229 Tây Sơn, Hà Nội 100000, Viêt Nam
  image: ./venue.jpg
image:
  media: "./cover.jpg"
  alt: "Hanoï, Viêt Nam"
...
schedule:
  items:
    ...
    - type: info
      ...
      startTime: 2026-03-07T11:30:00.000Z
    - type: conference
    ...
    - type: info
      ...
      startTime: 2026-03-07T12:20:00.000Z
    - type: conference
...
afterEventContent:
  photos:
    ...
    sources:
      - image: images/attendees-raising-hands.jpeg
        alt: Attendees raising their hands during a talk
      - image: images/speakers-on-stage.jpeg
        alt: Mathias Arlaud and Robin Chalas on stage presenting their talk "Shaping Symfony 8, Shipping Symfony 8, Lessons from the Inside"
      - image: images/full-room-view.jpeg
        alt: Full room view of attendees watching a talk
      - image: images/group-photo.jpeg
        alt: Group photo of attendees and speakers
subPages:
...
<a href="/events/2026-vietnam-hanoi/pages/informations" className={`${buttonVariants({ variant: 'secondary' })} not-prose`}>How to get there?</a>
