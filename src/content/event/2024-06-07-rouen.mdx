...
faq:
  - question: How many tickets are available for the event ?
    answer: At the moment, there are 50 early bird tickets available before the full price. In total, only 200 tickets will be available.
  - question: In which languages will the talks be delivered?
    answer: Talks can be provided in any language (French or English are recommended). Fork it! Community will provide live translations to the attendees.
---
