...
React Advanced is one of Europe’s flagship conferences dedicated to experienced
React and frontend engineers who want to push their understanding of the React
ecosystem beyond the basics. Unlike beginner-friendly meetups, React Advanced
focuses on deep technical topics, modern architectures, Server Components,
performance, accessibility, tooling, and even the unexpected ways React can be
used outside the browser. It brings together maintainers, seasoned developers,
and curious engineers who want to stay ahead of the curve, challenge their
mental models, and discover what’s next in the world of React and JavaScript.
Whether you’re a frontend dev, a full-stack practitioner, or someone passionate
about the future of web development, React Advanced is built for you.
