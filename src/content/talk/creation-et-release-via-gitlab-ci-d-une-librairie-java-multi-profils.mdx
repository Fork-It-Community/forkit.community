...
chatgpt a traduit ca en anglais et ca donne ca
car nous on fait la com en anglais
Subject: Creating and Releasing a Multi-Profile Java Library via GitLab CI: A How-To Guide
Abstract:
In more and more projects, we find ourselves needing libraries to share code and features, all while managing different framework versions. At CamelStudio, we encountered this need in one of our projects: developing a Java library compatible with both Java 17 and Java 8. :scream:
