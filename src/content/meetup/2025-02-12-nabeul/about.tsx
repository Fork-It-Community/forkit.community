...
import LocationImage from "/public/meetups/2025-02-12-nabeul.jpg";
        ...
        <div className="flex-col lg:flex lg:w-1/2 lg:shrink lg:grow-0 xl:absolute xl:inset-y-0 xl:right-1/2 xl:w-1/2">
          ...
          <div className="flex items-center justify-center gap-1">
            <a
              ...
              href="https://www.flickr.com/people/73714833@N00"
              target="_blank"
            >
              grolli77,
            </a>
            <a
              href="https://creativecommons.org/licenses/by-sa/2.0/deed.fr"
              className="underline"
              target="_blank"
            >
              license
