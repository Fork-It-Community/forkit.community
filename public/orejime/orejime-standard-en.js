!(function () {
  ...
  function E(e) {
    ((!e.__d && (e.__d = !0) && s.push(e) && !x.__r++) ||
      c !== l.debounceRendering) &&
      ((c = l.debounceRendering) || u)(x);
  }
  function x() {
    var e, t, n, o, r, i, a, c;
    for (s.sort(d); (e = s.shift()); )
      e.__d &&
        ((t = s.length),
        (o = void 0),
        (i = (r = (n = e).__v).__e),
  ...
  function P(e, t, n, o, r, i, l, a, s, c, u) {
    var d,
      _,
      p,
      f,
    ...
    for (
              ...
              (r = e.__k[o] =
                ...
                "function" == typeof r
                  ...
                  : "string" == typeof r ||
                    ...
                    ? w(null, r, null, null, null)
                    : g(r)
                      ? w(C, { children: r }, null, null, null)
                      : void 0 === r.constructor && r.__b > 0
                        ? w(r.type, r.props, r.key, r.ref ? r.ref : null, r.__v)
                        : r)
                ? ((r.__ = e),
                  (r.__b = e.__b + 1),
                  (a = (function (e, t, n, o) {
                    ...
                    if (
                      null === s ||
                      (s && r == s.key && i === s.type && 0 == (131072 & s.__u))
                    )
                      return n;
      ...
      null != (p = n.__k[d]) &&
        "boolean" != typeof p &&
        "function" != typeof p &&
        ((_ = -1 === p.__i ? m : y[p.__i] || m),
        (p.__i = d),
        T(e, p, _, r, i, l, a, s, c, u),
        (f = p.__e),
        p.ref &&
          _.ref != p.ref &&
          (_.ref && L(_.ref, null, p), u.push(p.ref, p.__c || f, p)),
        null == h && null != f && (h = f),
          ...
          ? (s = (function e(t, n, o) {
              ...
              if ("function" == typeof t.type) {
                for (r = t.__k, i = 0; r && i < r.length; i++)
                  r[i] && ((r[i].__ = t), (n = e(r[i], n, o)));
                return n;
              }
              t.__e != n &&
                (n && t.type && !o.contains(n) && (n = N(t)),
                o.insertBefore(t.__e, n || null),
                (n = t.__e));
    ...
    e: if ("style" === t) {
      ...
      ((i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1"))),
        ...
        n
          ? o
            ? (n.u = o.u)
            : ((n.u = _), e.addEventListener(t, i ? f : p, i))
  ...
  function T(e, t, n, o, r, a, s, c, u, d) {
    var _,
      p,
      f,
      h,
    ...
    (128 & n.__u && ((u = !!(32 & n.__u)), (a = [(c = t.__e = n.__e)])),
      (_ = l.__b) && _(t));
    e: if ("function" == typeof D)
      try {
        if (
          ...
          (A = (_ = D.contextType) && o[_.__c]),
          (M = _ ? (A ? A.props.value : _.__) : o),
          n.__c
          ...
          x &&
            ...
            b(p.__s, D.getDerivedStateFromProps(E, p.__s))),
          (h = p.props),
          (v = p.state),
          (p.__v = t),
          f)
          ...
          if (
            (x &&
              ...
              p.componentWillReceiveProps(E, M),
            !p.__e &&
              ((null != p.shouldComponentUpdate &&
                !1 === p.shouldComponentUpdate(E, p.__s, M)) ||
                t.__v === n.__v))
          ) {
            for (
              t.__v !== n.__v &&
                ((p.props = E), (p.state = p.__s), (p.__d = !1)),
                t.__e = n.__e,
                t.__k = n.__k,
          ...
          (null != p.componentWillUpdate && p.componentWillUpdate(E, p.__s, M),
            x &&
        ...
        if (
          ...
          for (
            p.state = p.__s,
              p.__d = !1,
              I && I(t),
              _ = p.render(p.props, p.state, p.context),
              S = 0;
            S < p._sb.length;
            S++
          )
        ...
        ((p.state = p.__s),
          ...
          x &&
            ...
            (y = p.getSnapshotBeforeUpdate(h, v)),
          P(
            e,
            g(
              (U =
                null != _ && _.type === C && null == _.key
                  ? _.props.children
                  : _),
            )
              ? U
        ...
        if (((t.__v = null), u || null != a)) {
          for (t.__u |= u ? 160 : 32; c && 8 === c.nodeType && c.nextSibling; )
            c = c.nextSibling;
      ...
      null == a && t.__v === n.__v
        ...
        : (t.__e = (function (e, t, n, o, r, l, a, s, c) {
            var u,
              d,
              _,
              p,
            ...
            if (null == e) {
              ...
              ((e = document.createElementNS(r, w, b.is && b)),
                (l = null),
                (s = !1));
            }
            if (null === w) y === b || (s && e.data === b) || (e.data = b);
            else {
              if (
              ...
              for (u in y)
                if (((f = y[u]), "children" == u));
                else if ("dangerouslySetInnerHTML" == u) _ = f;
                else if ("key" !== u && !(u in b)) {
                  if (
              ...
              if (d)
                (s ||
                  (_ && (d.__html === _.__html || d.__html === e.innerHTML)) ||
                ...
                P(
                  ...
                  n,
                  o,
                  "foreignObject" === w ? "http://www.w3.org/1999/xhtml" : r,
                  l,
                  a,
                  l ? l[0] : n.__k && N(n, 0),
                  s,
                ...
                for (u = l.length; u--; ) null != l[u] && j(l[u]);
              s ||
                ((u = "value"),
                void 0 === h ||
                  (h === e[u] &&
                  ...
                  B(e, u, h, y[u], r),
                (u = "checked"),
                void 0 !== v && v !== e[u] && B(e, u, v, y[u], r));
            }
            return e;
          })(n.__e, t, n, o, r, a, s, u, d));
    (_ = l.diffed) && _(t);
  }
  function I(e, t, n) {
    t.__d = void 0;
  ...
  function S(e, t, n) {
    ...
    if ((o = e.__k))
      for (r = 0; r < o.length; r++)
        o[r] && S(o[r], t, n || "function" != typeof e.type);
        ...
        (e = ((!o && n) || t).__k =
          (function (e, t, n) {
            var o,
              ...
              a = {};
            for (l in t)
              "key" == l ? (o = t[l]) : "ref" == l ? (r = t[l]) : (a[l] = t[l]);
            if (
              (arguments.length > 2 &&
              ...
              for (l in e.defaultProps)
                void 0 === a[l] && (a[l] = e.defaultProps[l]);
            return w(e, a, o, r, null);
          })(C, null, [e])),
        r || m,
        m,
        t.namespaceURI,
        !o && n ? [n] : r ? null : t.firstChild ? i.call(t.childNodes) : null,
        a,
    ...
    return (
      ...
      (function (e, t, n) {
        ...
        if (
          ...
          (($.componentWillUpdate = function (e, t, n) {
            if (this.__e) {
              var o = i;
  ...
  function et(e, t) {
    var n = Z(F++, 3);
    !z.__s && ec(n.__H, t) && ((n.__ = e), (n.i = t), $.__H.__h.push(n));
  }
  function en(e, t) {
    var n = Z(F++, 4);
    !z.__s && ec(n.__H, t) && ((n.__ = e), (n.i = t), $.__h.push(n));
  }
  function eo(e) {
    return (
      (q = 5),
      (function (e, t) {
        var n = Z(F++, 7);
        return (ec(n.__H, t) && ((n.__ = e()), (n.__H = t), (n.__h = e)), n.__);
      })(function () {
        return { current: e };
      }, [])
    );
  ...
  function er(e) {
    ...
    return (
      (n.c = e),
      t ? (null == n.__ && ((n.__ = !0), t.sub($)), t.props.value) : e.__
    );
  }
  function ei() {
    for (var e; (e = K.shift()); )
      if (e.__P && e.__H)
        try {
          (e.__H.__h.forEach(ea), e.__H.__h.forEach(es), (e.__H.__h = []));
        } catch (t) {
    ...
    (z.__r = function (e) {
      ...
      (t &&
        (R === $
          ...
          : (t.__h.forEach(ea), t.__h.forEach(es), (t.__h = []), (F = 0))),
        (R = $));
    }),
    (z.diffed = function (e) {
      V && V(e);
      ...
      (t &&
        t.__H &&
        (t.__H.__h.length &&
          ((1 !== K.push(t) && W === z.requestAnimationFrame) ||
            (
              (W = z.requestAnimationFrame) ||
              function (e) {
                var t,
                  n = function () {
                    (clearTimeout(o),
  ...
  let ed = {
    ...
    e_ = (e) => e.flatMap((e) => ("purposes" in e ? e_(e.purposes) : [e])),
    ep = (e) =>
      "string" == typeof e ? { src: e, alt: "" } : { src: "", alt: "", ...e },
    ef = (e, t) => !!e.length && e.every(t),
    eh = (e, t) => e.filter((e) => !t.includes(e)),
    em = (e, t) => Object.fromEntries(e.map((e) => [e[t], e])),
    ev = (e, t) => {
  ...
  var ek =
    ...
    }).Provider.__ = eX.Consumer.contextType =
      eX));
  let eN = (e, t) =>
      e ? ("string" == typeof e ? document.querySelector(e) : e) : t,
    eE = (e) => {
      let t = eN(e) || document.createElement("div");
      return (
        !t.classList.contains("orejime-Root") &&
          t.classList.add("orejime-Root"),
        !t.parentNode &&
    ...
    eB = (e, t, n) => {
      let o = (Number(e.dataset.translation) || 0) + t * n;
      Math.sign(o) === Math.sign(n)
        ? ((e.dataset.translation = o.toString()),
          (e.style.transform = `translateY(${o}px)`))
        : (delete e.dataset.translation, (e.style.transform = ""));
    },
    eM = (e) => {
      let t = window
        .getComputedStyle(e)
        .getPropertyValue("--orejime-collision-padding");
      return t.length ? parseInt(t, 10) : 16;
    },
    eT = (e, t) => ({
      top: e.top + t,
      right: e.right + t,
    ...
    eI = (e, t) => {
      ...
      let n = eT(e.getBoundingClientRect(), eM(t)),
        o = t.getBoundingClientRect();
      if (!(o.left < n.right && o.right > n.left)) {
        eB(t, 0);
        return;
      }
      let r = o.top + o.height / 2 > window.innerHeight / 2 ? 1 : -1,
        i = r > 0 ? n.bottom - o.top : o.bottom - n.top;
      if (!(o.top < n.bottom && o.bottom > n.top)) {
        eB(t, i, r);
        return;
      }
      let l = document.documentElement,
        a =
          r > 0
            ? Math.abs(l.scrollHeight - l.clientHeight - l.scrollTop)
            : l.scrollTop;
      (window.scrollBy({ top: i * r }), i > a && eB(t, i - a, r));
    },
    eL = () => {
      let { config: e } = er(ek);
      return e;
    ...
    eF = (e) => {
      let t = eU();
      return [
        ew(e, t.getAllConsents()),
        eC(e, t.getAllConsents()),
        () => {
          t.setConsents(eg(e));
        },
        () => {
          ...
          children: [
              ...
              children: [
                u.banner.title &&
                  H("h1", {
                    ...
                    children: u.banner.title,
                  }),
                H("p", {
                  className: "orejime-Banner-description",
                  children: eW(u.banner.description, {
                    purposes: H(
                      "strong",
                      {
                    ...
                    privacyPolicy: H(
                      "a",
                      {
                        ...
                        href: r,
                        children: u.banner.privacyPolicyLabel,
                      },
                      "privacyPolicyLink",
                    ),
                  }),
            ...
            H("ul", {
              ...
              children: [
                H("li", {
                  className:
                    "orejime-Banner-actionItem orejime-Banner-actionItem--save",
                  children: H("button", {
                    className:
                      "orejime-Button orejime-Button--save orejime-Banner-button orejime-Banner-saveButton",
                    type: "button",
                    title: u.banner.acceptTitle,
                    onClick: l,
                    "data-testid": "orejime-banner-accept",
                    children: u.banner.accept,
                  }),
                }),
                H("li", {
                  className:
                    "orejime-Banner-actionItem orejime-Banner-actionItem--decline",
                  children: H("button", {
                    className:
                      "orejime-Button orejime-Button--decline orejime-Banner-button orejime-Banner-declineButton",
                    type: "button",
                    title: u.banner.declineTitle,
                    onClick: a,
                    "data-testid": "orejime-banner-decline",
                    children: u.banner.decline,
                  }),
                }),
                H("li", {
                  className:
                  ...
                  children: H("button", {
                    type: "button",
                    className:
                      "orejime-Button orejime-Button--info orejime-Banner-learnMoreButton",
                    title: u.banner.configureTitle,
                    onClick: s,
                    "data-testid": "orejime-banner-configure",
                    children: u.banner.configure,
                  }),
                }),
              ],
            }),
      ...
      (eZ = (function () {
        ...
        function n(e) {
          var t = e.targetModal,
            ...
            u = e.disableScroll,
            d = e.disableFocus,
            _ = e.awaitCloseAnimation,
            p = e.awaitOpenAnimation,
            f = e.debugMode;
          ((function (e, t) {
            if (!(e instanceof t))
            ...
            (this.config = {
              ...
              openTrigger: void 0 === a ? "data-micromodal-trigger" : a,
              closeTrigger: void 0 === s ? "data-micromodal-close" : s,
              openClass: void 0 === c ? "is-open" : c,
              onShow: void 0 === i ? function () {} : i,
              onClose: void 0 === l ? function () {} : l,
              awaitCloseAnimation: void 0 !== _ && _,
              awaitOpenAnimation: void 0 !== p && p,
              disableFocus: void 0 !== d && d,
            }),
            r.length > 0 && this.registerTriggers.apply(this, eG(r)),
        ...
        return (
          (e = [
            ...
            },
            {
              ...
              value: function () {
                return Array.apply(void 0, eG(this.modal.querySelectorAll(eQ)));
              },
            },
            {
      ...
      }),
      {
        init: function (e) {
          var t,
            ...
            i = eG(document.querySelectorAll("[".concat(r.openTrigger, "]"))),
            l =
              ((t = i),
              (n = r.openTrigger),
              (o = []),
              ...
              o);
          if (!0 !== r.debugMode || !1 !== e2(i, l))
            for (var a in l) {
              var s = l[a];
              ((r.targetModal = a), (r.triggers = eG(s)), (e0 = new eZ(r)));
            }
        },
        show: function (e, t) {
          var n = t || {};
          ((n.targetModal = e),
            (!0 === n.debugMode && !1 === e1(e)) ||
              (e0 && e0.removeEventListeners(), (e0 = new eZ(n)).showModal()));
        },
        close: function (e) {
          e ? e0.closeModalById(e) : e0.closeModal();
        },
      });
  "undefined" != typeof window && (window.MicroModal = e3);
  var e6 = (e) => {
      let {
          isAlert: t = !1,
          label: n,
        ...
        d = (function () {
          var e = Z(F++, 11);
          if (!e.__) {
            for (var t = $.__v; null !== t && !t.__m && null !== t.__; )
              t = t.__;
      ...
      return (
        ...
        et(() => {
          null !== _ &&
            setTimeout(() => {
              (s && window.scrollTo(window.pageXOffset, _), p(null));
            }, 0);
        }),
        et(
          () => (
            a && document.documentElement.classList.add(a),
            e3.show(d, { onClose: c }),
            () => {
              (e3.close(d), a && document.documentElement.classList.remove(a));
            }
          ),
          [],
        ),
  ...
  (((e = t || (t = {}))[(e.declined = 0)] = "declined"),
    (e[(e.accepted = 1)] = "accepted"),
    (e[(e.partial = 2)] = "partial"));
  function e5(e) {
  ...
  var e7 = (function e(t, n) {
    function o(e, o, r) {
      if ("undefined" != typeof document) {
        ("number" == typeof (r = e5({}, n, r)).expires &&
    ...
    return Object.create(
      {
        ...
        withAttributes: function (t) {
          return e(this.converter, e5({}, this.attributes, t));
        },
        withConverter: function (t) {
          return e(e5({}, this.converter, t), this.attributes);
        },
      },
      {
  ...
  let e8 = (e) => {
      let t = e.split("."),
        ...
        o = t.slice(0, -2),
        r = [n];
      for (let e = 0; e < o.length; e++) r.push(o.slice(e).concat(n));
    ...
    tt = function (e) {
      ...
      e7.set(e, t, { expires: n, domain: o, sameSite: r });
    },
    tn = function (e) {
      let t =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "/",
        n = arguments.length > 2 ? arguments[2] : void 0;
      (n ? [n] : e8(location.hostname)).forEach((n) => {
        e7.remove(e, { path: t, domain: n });
      });
    };
  class to {
    #e;
  ...
  var tr = (e) => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"),
    ti = (e) => {
      let t = e4();
      e.forEach((e) => {
        let n, o;
        (e instanceof Array && ([e, n, o] = e),
          !(e instanceof RegExp) && (e = RegExp(`^${tr(e)}$`)),
          t
            .filter((t) => e.test(t))
            .forEach((e) => {
              tn(e, n, o);
  ...
  let tc = (e, t) =>
    ...
    tu = (e, t) =>
      Object.keys(e).reduce((n, o) => ({ ...n, [o]: t[o] ?? e[o] }), {});
  class td extends ts {
    #t;
    #l;
    #a;
    ...
    constructor(e, t = {}) {
      (super(),
        ...
        (this.#t = e),
        (this.#u = tu(this.#a, t)),
        (this.#c = Object.keys(t).length > 0 && this.#s.length > 0));
    }
    clone() {
      return new td(this.#t, this.getAllConsents());
    }
    isDirty() {
    ...
    setConsents(e) {
      (this.#d(e), this.#_(eh(this.#s, Object.keys(e))));
    }
    clearConsents() {
      (this.#d({ ...this.#a }),
        this.#_(
    ...
    #d(e) {
      let t = tu(e, this.#l),
        n = tc(this.#u, t);
      ((this.#u = { ...this.#u, ...t }),
        this.emit("update", n, { ...this.#u }));
    }
    #_(e) {
      ((this.#s = e),
        0 === this.#s.length && (this.#c = !1),
  ...
  var t_ = (e, t) => {
      t
        ? document
            .querySelectorAll(
              `template[data-purpose="${e}"]:not([data-active])`,
            )
            .forEach((e) => {
              ((e.dataset.active = "active"),
                Array.from(e.content.cloneNode(!0).children).forEach((t) => {
                  ((t.dataset.purpose = e.dataset.purpose),
    ...
    tf = (e) => {
      let { purposes: n, children: o, ...r } = e,
        [i, l, a, s] = eF(n),
        { Purpose: c } = eO();
      return H(c, {
        ...r,
        consent: i ? t.accepted : l ? t.declined : t.partial,
        onChange: (e) => (e ? a() : s()),
        children: o,
      });
    },
    th = (e) => {
      let [n, o] = e$(e.id),
        { Purpose: r } = eO();
      return H(r, { ...e, consent: n ? t.accepted : t.declined, onChange: o });
    };
  let tm = (e) => {
    let { purposes: t } = e,
      { PurposeList: n } = eO();
    return H(n, {
      children: t.map((e) =>
        "purposes" in e
          ? H(tf, { ...e, children: H(tm, { purposes: e.purposes }) }, e.id)
          : H(th, { ...e }, e.id),
      ),
    });
  };
  function tv(e) {
    let { children: t, onCommit: n } = e,
      { manager: o, ...r } = er(ek),
      { current: i } = eo(o.clone());
    return H(ek.Provider, {
      value: { ...r, manager: i },
      children: t(() => {
  ...
  var ty = () => {
    ...
    tg = (e) => {
      ...
      let { apiRef: r } = e,
        ...
        a = eD(),
        [s, c, u] = eH(),
        { Banner: d, Modal: _, ModalBanner: p } = eO(),
        f = eo(),
        h = i.forceBanner ? p : d;
      return (
        (t = r),
              ...
              ? H("div", {
                  ...
                  children: H(
                    h,
                    {
                      ...
                      purposeTitles: i.purposes.map((e) => {
                        let { title: t } = e;
                        return t;
                      }),
                  ...
                  children: (e) =>
                    H(
                      _,
                      {
                        ...
                        onSave: e,
                        children: [
                          l.areAllPurposesMandatory() ? null : H(ty, {}),
                          H(tm, { purposes: i.purposes }),
                        ],
                      },
                      "modal",
                    ),
  ...
  var tj = (e) => {
    let { purposeId: t, data: n, isEnabled: o } = e,
      r = eL(),
      i = eU(),
      l = eS(),
      { ContextualNotice: a } = eO(),
      [s, c] = ee(!1);
    if (!o && !s) return null;
    let u = e_(r.purposes).find((e) => {
      let { id: n } = e;
      return n === t;
    });
    return u
      ? H("div", {
          className: "orejime-Env",
          children: o
            ? H(a, {
                purpose: u,
                data: n,
            ...
            : s
              ? H("div", {
                  ...
                  title: eW(l.contextual.accepted, { purpose: u.title }).join(
                    "",
                  ),
                  tabIndex: -1,
                  ref: (e) => {
  ...
  class tw {
    ...
    apply(e) {
      Object.entries(e).forEach((e) => {
        let [t, n] = e;
        document
          .querySelectorAll(`template[data-contextual][data-purpose="${t}"]`)
          .forEach((e) => {
            this.#m(e, !n);
          });
      });
  ...
  var tC = (e, t) => {
    let n = eE(e.orejimeElement),
      o = { current: null },
      r = tb(() => {
        U(
          H(ek.Provider, {
            value: { config: e, manager: t },
            children: H(tg, { apiRef: o }),
          }),
          n,
        );
      }),
      ...
      return t.reduce(
        (e, t) => (
          Object.keys(t).forEach((n) => {
            let o = e[n],
              r = t[n];
            Array.isArray(o) && Array.isArray(r)
              ? (e[n] = o.concat(...r))
              : tk(o) && tk(r)
                ? (e[n] = tN(o, r))
                : (e[n] = r);
  ...
  var tE = (e) => {
    let t = tN(ed, e);
    !(function (e) {
      if (!Object.keys(e.purposes).length)
        throw Error("Orejime config: you must define `purposes`");
      if (!e.privacyPolicyUrl.length)
        throw Error("Orejime config: you must define `privacyPolicyUrl`");
    })(t);
    let n = tp(e_(t.purposes), { cookie: t.cookie }),
      { openModal: o } = tC(t, n);
    return { config: t, manager: n, prompt: o };
  };
  ((e, t) => {
    let n = (n) => {
        let o = tE(tN({ translations: t }, { ...n, theme: e }));
        return (
          "undefined" != typeof CustomEvent &&
            document.dispatchEvent(
              new CustomEvent("orejime.loaded", { detail: o }),
            ),
          o
        );
      },
      o = async () => {
        ((window.loadOrejime = n),
          void 0 !== window.orejimeConfig &&
            void 0 === window.orejime &&
            (window.orejime = n(window.orejimeConfig)));
      };
  ...
  })(
    {
      Banner: eq,
      ContextualNotice: (e) => {
        let { purpose: t, data: n, onAccept: o, privacyPolicyUrl: r } = e,
          i = eS(),
          { titleLevel: l } = n,
          a = l ? `h${l}` : "strong",
          s = {
            ...
            privacyPolicy: H(
              "a",
              { href: r, children: i.contextual.privacyPolicyLabel },
              "privacyPolicyUrl",
            ),
          };
        return H("div", {
          ...
          children: [
            H(a, {
              ...
              children: eW(i.contextual.title, s),
            }),
            H("p", {
              className: "orejime-ContextualNotice-description",
              children: eW(i.contextual.description, s),
            }),
            H("button", {
              className: "orejime-ContextualNotice-button orejime-Button",
              title: i.contextual.acceptTitle
                ? eW(i.contextual.acceptTitle, s).join("")
                : null,
              onClick: o,
              "data-testid": "orejime-contextual-notice-accept",
              children: eW(i.contextual.accept, s),
            }),
          ],
        });
      },
      GlobalConsent: (e) => {
        let { isEnabled: t, isDisabled: n, acceptAll: o, declineAll: r } = e,
          i = eS();
        return H("div", {
          ...
          children: [
            H("button", {
              type: "button",
              className:
                "orejime-Button orejime-Button--info orejime-PurposeToggles-button orejime-PurposeToggles-enableAll",
              "aria-disabled": t,
              onClick: o,
            ...
            H("button", {
              type: "button",
              className:
                "orejime-Button orejime-Button--info orejime-PurposeToggles-button orejime-PurposeToggles-disableAll",
              "aria-disabled": n,
              onClick: r,
          ...
          children: H("div", {
            ...
            children: [
                    ...
                    children: [
                      t && n
                        ? H("p", {
                            className: "orejime-Modal-description",
                            children: H("strong", {
                              className: "orejime-Modal-changes",
                              children: a.misc.updateNeeded,
                            }),
                          })
                        : null,
                      eW(a.modal.description, {
                        privacyPolicy: H(
                          "a",
                          {
                            ...
                            href: o,
                            children: a.modal.privacyPolicyLabel,
                          },
                          "privacyPolicyLink",
                        ),
                      }),
              ...
              H("form", {
                ...
                children: [
                  H("div", { className: "orejime-Modal-body", children: l }),
                  H("div", {
                    ...
                    children: [
                      H("button", {
                        ...
                        title: a.modal.saveTitle,
                        "data-testid": "orejime-modal-save",
                        children: a.modal.save,
                      }),
                      H(e9, { className: "orejime-Modal-poweredByLink" }),
                    ],
                  }),
                ],
              }),
      ...
      Purpose: (e) => {
        ...
        return (
          et(() => {
            _.current && (_.current.indeterminate = a === t.partial);
          }, [a]),
          H("div", {
              ...
              H("label", {
                ...
                children: [
                  ...
                  i
                    ? H("span", {
                        className:
                          "orejime-Purpose-attribute orejime-Purpose-attribute--mandatory",
                  ...
                  l
                    ? H("span", {
                        className:
                          "orejime-Purpose-attribute orejime-Purpose-attribute--exempt",
                  ...
                  H("span", {
                    className:
                      "orejime-Purpose-attribute orejime-Purpose-attribute--state",
                    "aria-hidden": "true",
                    children:
                      a === t.accepted
                        ? u.purpose.enabled
      ...
      PurposeList: (e) => {
        ...
        return H("ul", {
          ...
          children: t.map((e) =>
            H("li", { className: "orejime-PurposeList-item", children: e }),
          ),
        });
      },
    },
